...
exports.Song = exports.db = void 0;
...
exports.db = db;
var Song = sequelize.define('song', { title: Sequelize.STRING, author: Sequelize.STRING, path: Sequelize.STRING });
exports.Song = Song;
function init() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
function allSongs(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            Song.findAll().then(function (response) {
                res.send(response);
            });
            return [2 /*return*/];
        });
